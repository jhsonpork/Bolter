      ...
      <section className="px-6 py-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-12">
            ...
            <p className="text-gray-500 text-sm mt-2">Create an account to save and manage your campaigns</p>
            <button
              onClick={() => setShowAuthModal(true)}
              className="mt-6 px-6 py-3 bg-gradient-to-r from-yellow-400 to-amber-500 text-black font-semibold 
